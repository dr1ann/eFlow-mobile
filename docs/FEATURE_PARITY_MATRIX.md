...
| Project and task management | 2 | Contract-dependent | Atomic project/task RPCs, task-assignment RPC, authoritative deadline contracts, RLS | Blocked | No mobile mutations are enabled. Participant scope, audit/notification atomicity, project edit, member/milestone, and task-deadline contracts require backend hardening and allowed/denied probes. |

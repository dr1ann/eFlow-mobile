-- Fix permanent project deletion when linked tasks also reference one of the
-- project's milestones. Both task planning links must be cleared atomically
-- before project/milestone foreign-key actions execute.
